 ...
 ***************************************************************************************
 */
package com.rentian.newoa.receiver;
...
public final class CIMPushManagerReceiver extends CIMEventBroadcastReceiver {
	...
	private void  showNotify(Context context , Message msg)
	{
		...
		PendingIntent contentIntent = PendingIntent.getActivity(context,1, new Intent(context,LoginActivity.class), PendingIntent.FLAG_UPDATE_CURRENT);
