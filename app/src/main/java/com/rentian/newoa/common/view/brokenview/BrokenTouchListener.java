package com.rentian.newoa.common.view.brokenview;
...
public class BrokenTouchListener implements View.OnTouchListener {
    ...
    private final static int RETURN_TOUCH_DOWN = 1001;
    ...
    public void setOnTouchManager(OnTouchManager OnTouchManager) {
