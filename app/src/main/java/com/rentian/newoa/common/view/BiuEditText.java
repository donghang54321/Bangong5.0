...
//
//import com.rentian.rtsxy.modules.report.view.SendReportActivity;
//
...
//
//
//                    String last=s.toString().substring(cacheStr.length(),s.length() );
//                    update(last, true);
//                } else {
//
...
//
//    private void init() {
//        contentContainer = (ViewGroup) ((SendReportActivity) getContext()).findViewById(android.R.id.content);
